...
export const Hero = () => {
  return (
    <section className="w-full relative overflow-hidden min-h-screen flex items-center justify-center">
      <>
        <video loop autoPlay className="absolute blur-[2px] overflow-hidden  top-0 left-0 z-0">
          <source
            type="video/mp4"
        ...
        <CustomSectionWrapper>
          <div className="text-white flex items-center justify-center flex-col space-y-4 relative z-">
            <h3 className="text-6xl  text-center text-white font-extrabold uppercase font-[Montserrat]">
              Welcome to UFA Academy
            </h3>
            <p className="font-medium text-lg mt-4 tracking-wide max-w-5xl text-center">
            ...
            <button className="mx-auto border rounded-md py-2 px-6 text-lg font-medium">
              Join Us
            </button>
          </div>
        </CustomSectionWrapper>
